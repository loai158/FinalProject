...
namespace FinalProject.App.Areas.Customer.Controllers
{
    ...
    public class ProfileController : Controller
    {
        ...
        //    if (user != null)
        //    {
        //        var userData = new DoctorRegisterVM
        //        {
        ...
        //    return View(new DoctorRegisterVM());
        //}
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(DoctorRegisterVM registerVM, IFormFile? Img, string OldPassword)
        //{
