...
{
  public  class RegisterApplyRepositoey : GenericRepositry<ApplyRequest>, IRegisterApplyRepositoey
    {
        private readonly ApplicationDbContext dbContext;

        public RegisterApplyRepositoey(ApplicationDbContext dbContext) : base(dbContext)
        {
