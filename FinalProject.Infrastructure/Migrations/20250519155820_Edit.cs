        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Perscribtions_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NurseProfileId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreviousConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreviousConditions_Patients_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreviousMedicines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreviousMedicines_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Carts_DoctorSchedules_DoctorScheduleId",
                        column: x => x.DoctorScheduleId,
                        principalTable: "DoctorSchedules",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Carts_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescribtionId = table.Column<int>(type: "int", nullable: true),
                    PerscribtionId = table.Column<int>(type: "int", nullable: true),
                    PreviousId = table.Column<int>(type: "int", nullable: true),
                    PreviousMedicineId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Interactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Interactions_Perscribtions_PerscribtionId",
                        column: x => x.PerscribtionId,
                        principalTable: "Perscribtions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Interactions_PreviousMedicines_PreviousMedicineId",
                        column: x => x.PreviousMedicineId,
                        principalTable: "PreviousMedicines",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_DoctorScheduleId",
                table: "Carts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interactions_PerscribtionId",
                table: "Interactions",
                column: "PerscribtionId");

            migrationBuilder.CreateIndex(
                name: "IX_Interactions_PreviousMedicineId",
                table: "Interactions",
                column: "PreviousMedicineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreviousConditions_PatientId",
                table: "PreviousConditions",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_PreviousMedicines_PatientId",
